    ...
    return(
        <div className="w-full flex justify-center h-screen items-center bg-slate-900">
            <div className="flex flex-row">
                <div className="w-[500px] bg-gradient-to-br from-pink-500 to-orange-400 flex flex-col h-auto items-center justify-center">
                ...
                <div className="bg-slate-100 p-[50px]">
                    ...
                    <form className="flex flex-col w-[500px] items-center px-[60px]"  onSubmit={ handleSubmit(async (values)=> {
                        console.log(values);
                        const valueRegister = await registerRequest(values)
                        console.log(valueRegister);
                    })}>
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="floating_last_name username" {...register("username", {required:true})} id="floating_last_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-orange-600 peer" placeholder=" " required />
